    ...
    <section className="bg-canvas py-section">
      <Container className="grid grid-cols-2 items-center gap-16">
        <Reveal className="space-y-6">
          ...
          <p className="font-serif text-display-sm text-ink">
            {c.kicker}
          </p>
          ...
          {showEvidence && (
            <div className="mt-6 rounded-xl border border-hairline bg-surface-soft p-6 shadow-soft">
              <h4 className="mb-3 text-title-md text-ink">
                Clinical Evidence Summary
              </h4>

              <ul className="space-y-2 text-body-md text-muted">
                <li>✓ Peer-reviewed clinical studies reviewed</li>
                <li>✓ Product claims validated against submitted data</li>
                <li>✓ Scientific references verified by experts</li>
                <li>✓ Transparency-focused evidence reporting</li>
              </ul>
            </div>
          )}
        </Reveal>
        ...
        <Reveal delay={120}>
          <div className="hover-lift rounded-xl border border-hairline bg-surface-soft p-12 text-center shadow-soft">
            ...
            <div className="text-caption-uppercase uppercase text-accent-strong">
              Verified
            </div>

            <h4 className="mt-2 text-title-lg text-ink">
              {c.badge}
            </h4>
