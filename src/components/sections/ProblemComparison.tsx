  ...
  return (
    <Section surface="soft">
      ...
      <div className="mx-auto grid max-w-5xl grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <Reveal className="bg-white rounded-xl p-8 border border-hairline tinted-shadow flex flex-col h-full justify-between">
          <div className="mb-auto">
            <span className="text-caption-uppercase uppercase text-muted-soft block mb-3 tracking-widest">
              {generic.label}
            </span>
        ...
        <Reveal className="bg-surface-soft rounded-xl tinted-shadow relative overflow-hidden shimmer-card p-8 flex flex-col h-full justify-between border border-hairline">
          {/* Shimmer line */}
